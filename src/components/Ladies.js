...
function Ladies() {
  ...
  const [img, setImg] = useState(collection[1].colors && collection[1].colors[0].image)
  const [prize, setprize] = useState(collection[1].size && collection[1].size[0].rupees)
  const handleClick = (e) => {
    let a = e.currentTarget.value;
    // console.log(a);
    setImg(collection[1].colors && collection[1].colors[a - 1].image)
    // setprize(collection[1].size && collection[1].size[a - 1].rupees)
  }
      ...
      <div className="row men">
            ...
            <div className="small_image">
              <div className="size-container">
                <div className="row pic_changers">
                  {collection[1].colors && collection[1].colors.map(style => {
                    return (
        ...
        <div className=" col-sm-6 partion main_content">
          <div className="content_head">
            <h5> <strong>{collection && collection[1].name} <br />{prize}</strong></h5>
          </div>
          <hr />
          <div className="content_body">
            <div className="information">
              ...
              <div className="row size name">
                ...
                <div className=" col-sm-10 size-container">
                  <div className="size-elements">
                    {collection[1].size && collection[1].size.map(sizes => {
                      return (
              ...
              <div className="row name">
                ...
                <div className="col-sm-10 size-container">
                  <div className="size-elements">
                    {collection[1].colors && collection[1].colors.map(rang => {
                      return (
                ...
                <div className="row model">
                  ...
                  <div className="col-sm-6 modal_content">
                    ...
                    <div className={`row image_icon${showing}`}>
                      {collection[1].icons && collection[1].icons.map(icon => {
                        return (
