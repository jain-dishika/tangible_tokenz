...
function ManWear() {
  ...
  const [img, setImg] = useState(collection[0].colors && collection[0].colors[0].image)
  const handleClick = (e) => {
    let a = e.currentTarget.value;
    // console.log(a);
    setImg(collection[0].colors && collection[0].colors[a - 1].image)
  }
      ...
      <div className="row men">
            ...
            <div className="small_image">
              <div className="size_container">
                <div className="row pic_changers">
                  {collection[0].colors && collection[0].colors.map(style => {
                    return (
        ...
        <div className=" col-sm-6 partion main_content">
          <div className="content_head">
            <h5> <strong>{collection && collection[0].name} <br />{collection && collection[0].rupees}</strong></h5>
          </div>
          <hr />
          <div className="content_body">
            <div className="information">
              ...
              <div className="row size name">
                ...
                <div className=" col-sm-10 size-container">
                  <div className={`size-elements`}>
                    {collection[0].size && collection[0].size.map(sizes => {
                      return (
              ...
              <div className="row name">
                ...
                <div className="col-sm-10 size-container">
                  <div className="size-elements">
                    {collection[0].colors && collection[0].colors.map(rang => {
                      return (
                        <Tippy content={rang.colorName} style={{color: "red"}}>
